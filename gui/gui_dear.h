...
#include "extern/dearimgui/imgui.h"
#include "extern/dearimgui/backends/imgui_impl_glfw.h"
#include "extern/dearimgui/backends/imgui_impl_opengl3.h"
#include <stdio.h>
...
struct IMGUI
{
    int winWidth = 1280;
    int winHeight = 720;
    std::string winTitle = "Colonia v0.1.0";
    int winVsync = 1;
    GLFWwindow *pWindow;
    // Our state
    ...
    int Init()
    {
        ...
        pWindow = glfwCreateWindow(winWidth, winHeight, winTitle.c_str(), NULL, NULL);
        if (pWindow == NULL)
        {
            return 1;
        }
        glfwMakeContextCurrent(pWindow);
        glfwSwapInterval(winVsync); // Enable vsync
